...
class ApplicationMain {
	...
	public static function create ():Void {
		...
		urls.push ("assets/experim1.csv");
		types.push (AssetType.TEXT);
		
		
		urls.push ("assets/experim2.csv");
		types.push (AssetType.TEXT);
		...
		urls.push ("assets/images/sunset.jpg");
		types.push (AssetType.IMAGE);
		
		
		urls.push ("assets/images/sunset.png");
		types.push (AssetType.IMAGE);
		
		
		urls.push ("assets/images/wubbles.png");
		types.push (AssetType.IMAGE);
		
		
		urls.push ("assets/images/wubbles2.png");
		types.push (AssetType.IMAGE);
		
		
		urls.push ("assets/mapDoor1.csv");
		types.push (AssetType.TEXT);
		
		
		urls.push ("assets/mapDoor2.csv");
		types.push (AssetType.TEXT);
		
		
		urls.push ("assets/mapHits2.csv");
		types.push (AssetType.TEXT);
		
		
		urls.push ("assets/mapHits3.csv");
		types.push (AssetType.TEXT);
		
		
		urls.push ("assets/mapTiles.png");
		types.push (AssetType.IMAGE);
		
		
		urls.push ("assets/music/DUCKSONG.wav");
		...
		urls.push ("assets/sounds/ducksong.wav");
		types.push (AssetType.SOUND);
		
		
		urls.push ("assets/tiles2.png");
		types.push (AssetType.IMAGE);
