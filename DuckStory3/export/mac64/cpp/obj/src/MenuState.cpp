...
{
		HX_STACK_FRAME("MenuState","clickPlay",0x5f6a9ec0,"MenuState.clickPlay","MenuState.hx",24,0xdfbcb22c)
		HX_STACK_THIS(this)
		HX_STACK_LINE(24)
...
Void MenuState_obj::create( ){
{
		...
		HX_STACK_THIS(this)
		HX_STACK_LINE(31)
		::flixel::text::FlxText headline = ::flixel::text::FlxText_obj::__new((int)0,(int)100,::flixel::FlxG_obj::width,HX_CSTRING("Duck Story 3"),(int)48,null());		HX_STACK_VAR(headline,"headline");
		HX_STACK_LINE(32)
		headline->set_alignment(HX_CSTRING("center"));
		HX_STACK_LINE(34)
		::flixel::FlxSprite _g = ::flixel::FlxSprite_obj::__new((int)0,(int)0,HX_CSTRING("assets/images/sunset.png"));		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(34)
		this->_bg2 = _g;
		HX_STACK_LINE(36)
		this->add(this->_bg2);
...
{
		HX_STACK_FRAME("MenuState","update",0xf0719b25,"MenuState.update","MenuState.hx",61,0xdfbcb22c)
		HX_STACK_THIS(this)
		HX_STACK_LINE(61)
		this->super::update();
	}
...
void MenuState_obj::__Visit(HX_VISIT_PARAMS)
{
	...
	HX_VISIT_MEMBER_NAME(_bg2,"_bg2");
...
Dynamic MenuState_obj::__Field(const ::String &inName,bool inCallProp)
{
	...
	case 4:
		if (HX_FIELD_EQ(inName,"_bg2") ) { return _bg2; }
		break;
	case 6:
...
Dynamic MenuState_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	switch(inName.length) {
	case 4:
		if (HX_FIELD_EQ(inName,"_bg2") ) { _bg2=inValue.Cast< ::flixel::FlxSprite >(); return inValue; }
		break;
	case 8:
...
void MenuState_obj::__GetFields(Array< ::String> &outFields)
{
	...
	outFields->push(HX_CSTRING("_bg2"));
...
static hx::StorageInfo sMemberStorageInfo[] = {
	...
	{hx::fsObject /*::flixel::FlxSprite*/ ,(int)offsetof(MenuState_obj,_bg2),HX_CSTRING("_bg2")},
	{ hx::fsUnknown, 0, null()}
};
#endif
