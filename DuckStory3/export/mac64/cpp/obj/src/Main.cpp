...
{
		HX_STACK_FRAME("Main","setupGame",0x7f7688ba,"Main.setupGame","Main.hx",65,0x087e5c05)
		HX_STACK_THIS(this)
		HX_STACK_LINE(66)
		...
		this->addChild(_g3);
		HX_STACK_LINE(79)
		::flixel::FlxG_obj::sound->playMusic(HX_CSTRING("assets/music/DUCKSONG.wav"),(int)1,true);
	}
return null();
}
...
Void Main_obj::main( ){
{
		HX_STACK_FRAME("Main","main",0xed0e206e,"Main.main","Main.hx",36,0x087e5c05)
		HX_STACK_LINE(37)
